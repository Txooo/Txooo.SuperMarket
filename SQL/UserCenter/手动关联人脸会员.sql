...
UPDATE dbo.gzy_user_third SET com_id=b.com_id
FROM dbo.gzy_user_third AS a 
LEFT JOIN TxoooBrands.dbo.brand_index AS b
ON a.brand_id=b.brand_id

UPDATE dbo.gzy_user_member 
SET user_id=b.user_id,com_id=b.com_id
FROM dbo.gzy_user_member AS a 
LEFT JOIN dbo.gzy_user_third AS b
ON a.mobile=b.mobile AND a.brand_id=b.brand_id

UPDATE dbo.gzy_user_third SET member_id=b.member_id
FROM dbo.gzy_user_third AS a
LEFT JOIN dbo.gzy_user_member AS b
ON b.brand_id = a.brand_id AND b.user_id = a.user_id
